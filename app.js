...
const REVIEWS = [
  ...
  },
  {
    name: 'Javier L.',
    stars: 5,
    text: 'NovaTech es mi proveedor de referencia para tecnología. Precios imbatibles y garantía real que funciona.',
    date: 'hace 1 mes',
    color: '#22c55e',
  },
];
...
console.log('%cNovaTech 🚀', 'color:#3b82f6;font-family:monospace;font-size:20px;font-weight:bold');
